...
const TABLE_HEAD = [
  ...
  { id: 'company', label: 'ИНН', align: 'left' },
  { id: 'role', label: 'Кол-во зарядный станций', align: 'left' },
  { id: 'company', label: 'Совершено зарядок', align: 'left' },
  { id: 'company', label: 'Заработано денег', align: 'left' },
  { id: 'company', label: 'Потрачено энергии', align: 'left' },
  { id: '' },
];
